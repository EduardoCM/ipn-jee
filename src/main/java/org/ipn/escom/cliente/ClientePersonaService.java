...
public class ClientePersonaService {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PersonaServiceRemote personaService = (PersonaServiceRemote) jndi.lookup("java:global/ipn-jee/PersonaServiceImpl!org.ipn.escom.service.PersonaServiceRemote");
